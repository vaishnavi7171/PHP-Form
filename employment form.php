    ...
    <body>
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
            ...
            elseif(!preg_match("/^[a-zA-z]/",$_POST["name"])){
                echo "<span class=\"error\">Error: Name can only conatain letters</span>";
            }
            elseif (empty($_POST["website"])){
                echo "<span class=\"error\">Error: Website Required</span>";
            }
            elseif(!preg_match(
                "/\b(?:(?:https?|ftp):\/\/|www\.)[-a-z0-9+48@\/%?=']*[-a-z0-9+48@\/%=''_|]/i",$_POST["website"])){
        ...
        ?>
         <form name="emloyment" action=""<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?> method="post">
             <table width="600" border="0" cellspacing="1" cellpadding="1">
                 ...
                 <tr>
                     <td>Website</td>
                         <td><input type="text" name="website" maxlength="50"/>
                     </td>
